...
C
  ...
  125 CONTINUE
      GO TO 128
  126 DO 127 I=1,M
         B(I) = .5d0*(Q(I,JM2)-Q(I,JM1)-Q(I,JM3))+Q(I,JP2)-
     &         Q(I,JP1)+Q(I,J)
  127 CONTINUE
  128 DO 129 I=1,M
  ...
  134 CONTINUE
      CALL COSGEN (KR,JSTSAV,0.d0,FI,TCOS)
...
C
  ...
  153 CONTINUE
      GO TO (154,155),IRREG
  154 CONTINUE
      CALL COSGEN (JST,1,0.5d0,0.d0,TCOS)
      IDEG = JST
      GO TO 156
  155 KR = LR+JST
      CALL COSGEN (KR,JSTSAV,0.d0,FI,TCOS)
      CALL COSGEN (LR,JSTSAV,0.d0,FI,TCOS(KR+1))
      IDEG = KR
  156 CONTINUE
...
C
  ...
  107 CONTINUE
      ...
      CALL COSGEN (I2R,1,0.5d0,0.d0,TCOS)
      I2RBY2 = I2R/2
...
C
  ...
  163 CONTINUE
      CALL COSGEN (JR,1,0.5d0,0.d0,TCOS)
  ...
  164 CONTINUE
      JR2 = 2*JR
      CALL COSGEN (JR,1,0.d0,0.d0,TCOS)
      DO 165 I=1,JR
         I1 = JR+I
         I2 = JR+1-I
         TCOS(I1) = -TCOS(I2)
...
C
  ...
  177 CONTINUE
      ...
      TCOS(K1+1) = -2.
      K4 = K1+3-ISTAG
      CALL COSGEN (K2+ISTAG-2,1,0.d0,FNUM,TCOS(K4))
      K4 = K1+K2+1
      CALL COSGEN (JR-1,1,0.d0,1.d0,TCOS(K4))
      CALL MERGE (TCOS,K1,K2,K1+K2,JR-1,0)
      K3 = K1+K2+LR
      CALL COSGEN (JR,1,0.5d0,0.d0,TCOS(K3+1))
      K4 = K3+JR+1
...
C
  ...
  189 CONTINUE
      ...
      TCOS(K1+1) = -2.
      K4 = K1+3-ISTAG
      CALL COSGEN (KR+ISTAG-2,1,0.d0,FNUM,TCOS(K4))
      K4 = K1+KR+1
      CALL COSGEN (JR-1,1,0.d0,1.d0,TCOS(K4))
