...
{
	public:
	static void initNeumann(DomainCollection<3> &dc, Vec f, Vec exact,
	...
	static void initDirichlet(DomainCollection<3> &dc, Vec f, Vec exact,
	                          std::function<double(double, double, double)> ffun,
	                          std::function<double(double, double, double)> efun);
	static void initNeumann2d(DomainCollection<2> &dc, Vec f, Vec exact,
	...
	static void initDirichlet2d(DomainCollection<2> &dc, Vec f, Vec exact,
	                            std::function<double(double, double)> ffun,
	                            std::function<double(double, double)> efun);
