...
function (linker_cmdline what INTO outvar FROM)
  ...
  string (REPLACE "." "\\." esc_ar_suff "${CMAKE_STATIC_LIBRARY_SUFFIX}")
...
function (configure_pc_file name source dest)
  # escape set of standard strings
  unseparate_args (includes "-I" "${${name}_Includes}")
  unseparate_args (defs "" "${${name}_DEFINITIONS}")
  linker_cmdline (STRING INTO libs FROM ${${name}_Libs})
...
endfunction (configure_pc_file name source dist)
