...
IF(EXISTS ${AMGX_DIR}/base/include/amgx_c.h)
  ...
  find_path (AMGX_INCLUDE_DIR amgx_c.h HINTS "${AMGX_DIR}/base/include" PATH_SUFFIXES include NO_DEFAULT_PATH)
  list(APPEND AMGX_INCLUDES ${AMGX_INCLUDE_DIR})
  FILE(GLOB AMGX_LIBRARIES RELATIVE "${AMGX_DIR}/lib" "${AMGX_DIR}/lib/libamgxsh.so")
ELSE(EXISTS ${AMGX_DIR}/base/include/amgx_c.h)
  SET(AMGX_FOUND NO)
ENDIF(EXISTS ${AMGX_DIR}/base/include/amgx_c.h)
